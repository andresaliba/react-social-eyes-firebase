      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        <div className="grid lg:grid-cols-1 ">
          <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700  ">
            ...
            <h1 className="mb-2 text-1xl font-bold tracking-tight text-gray-900 dark:text-white ">
              This project was made using React, TailwindCSS, Firebase and Vite
            </h1>
            <h1 className="mb-2 text-1xl font-bold tracking-tight text-gray-900 dark:text-white">
              Written using Typescript and deployed using Firebase Hosting{" "}
            </h1>
            ...
            <div className="flex justify-center  mb-5 font-light text-gray-500 dark:text-gray-400 gap-10 ">
              {/* GITHUB */}
              <button className="bg-gray-700 p-2" aria-label="github">
                <a href="https://github.com/andresaliba" target="_blank">
                  <svg
              ...
              {/* LINKEDIN */}
              <button className="bg-blue-600 p-2  " aria-label="linkedin">
                <a
                  href="https://www.linkedin.com/in/andretonisaliba/"
                  target="_blank"
                >
                  <svg
              ...
              {/* GMAIL */}
              <button className="bg-slate-300 p-2 " aria-label="gmail">
                <a href="mailto: andrecstk@gmail.com" target="_blank">
                  <svg
                    className="w-5 h-5 fill-current"
                    xmlns="http://www.w3.org/2000/svg"
                    width="1.33em"
